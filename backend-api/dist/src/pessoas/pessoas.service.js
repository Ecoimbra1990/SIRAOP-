...
const area_atuacao_entity_1 = require("./entities/area-atuacao.entity");
const storage_service_1 = require("../storage/storage.service");
const crypto = __importStar(require("crypto"));
let PessoasService = class PessoasService {
    constructor(pessoasRepository, areasRepository, storageService) {
...
exports.PessoasService = PessoasService = __decorate([
    ...
    __param(1, (0, typeorm_1.InjectRepository)(area_atuacao_entity_1.AreaAtuacao)),
